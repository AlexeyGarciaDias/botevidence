...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        #set in debug
        tl_admin_user = 'AlexeyGarciaDias'
        ...
        if '/start' in msgText:
            ...
            start_msg+= 'Desarrollador👨‍💻 : @AlexeyGarciaDias\n'
            ...
            #    bot_token = '5085125484:AAHdBj-ikJtX36JtciLRLD-GYDplyKBIIIs'
...
def main():
    ...
    #set in debug
    bot_token = '5216971170:AAHBo95mG_pJrH-3DDYcBodNfHkUjZjx0w4'
